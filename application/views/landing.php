      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="active" href="<? echo site_url("welcome"); ?>">
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
				<div class="col-md-12">
					...
					<div class="white-panel pn" id="mainbill">
					<div class="panel-heading">
							
	                        <div class="pull-left"><h4><i class="fa fa-tasks"></i> เลือก Queue </h4></div>
	                        <br>
	                 	</div>
						<br>
						...
						<td>
						<select class="form-control" id="selectqueue" name="selectqueue" >
							...
							<option >Wine</option>
							<option >Sofa</option>
							<option >หน้า CT</option>
							<option >กระจก</option>
							<option >ติด CT</option>							
							<option >บาร์</option>
							<option >นอก</option>
							<option >บน</option>
							<option >กลับ</option>
						...
						<!--/showback -->
							...
							<button type="button" class="btn btn-primary" OnClick="JavaScript:creBill();">ตกลง</button>
						</td><tr>
						</table>
						<br>
...
/////////////////////////////////////////////// DatePicker ////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////  Crebill ///////////////////////////////////////////////////////////
		...
		function creBill() {
			...
			var queue = document.getElementById("selectqueue");
			...
			if(queueval==0){
				...
				.success(function(result) { 
					...
					if(obj != ''){
						...
						$("#pay").html("<button type='button' class='btn btn-success' name='pay' id='pay'  OnClick='JavaScript:payBill();'>ชำระรายการ</button>");
						});					
					}
				});
				...
				.success(function(result) { 
					...
					if(obj != ''){
						...
						//$("#item").html(" <font >"+item+" - "+option+" ราคา "+price+"</font>"); 
							var tr = "<tr>";
							tr = tr + "<td>" + item + "</td>";
							if(option!="0"){tr = tr + "<td>" + option + "</td>";}else{tr = tr + "<td></td>";}
							tr = tr + "<td>" + price + "</td>";
