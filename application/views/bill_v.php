					...
					var obj = jQuery.parseJSON(result);
						if(obj != '')
						{
							  ...
							  $.each(obj, function(key, val) {
										...
										tr = tr + "<td><button type='button' class='btn btn-round btn-info'><font>"  + val["date"] + " </font></button></td>";
										tr = tr + "<td><button type='button' class='btn btn-success' OnClick='JavaScript:listBill("+val["billid"]+");'> ดูรายการ </button></td>";
										tr = tr + "<td><a href='edit/editbill/"+val["billid"]+"/"+val["queue"]+"'><button type='button' class='btn btn-warnning' ><i class='fa fa-cog'></i> แก้ไข </button></a></td>";
										tr = tr + "</tr>";
				...
				.success(function(result) { 
					var obj = jQuery.parseJSON(result);
						if(obj != '')
						{
							...
							pay = parseInt(total);
							var tr = "<tr>";
							tr = tr + "<td><button type='button' class='btn btn-success' OnClick='JavaScript:payBill("+billid+","+pay+");'>ชำระรายการ</button></td>";
							tr = tr + "<td></td>";
